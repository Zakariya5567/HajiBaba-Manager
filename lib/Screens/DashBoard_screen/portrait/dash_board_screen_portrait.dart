...
class PortraitDashBoardScreen extends StatelessWidget {
  ...
  //get data is a function when the user first time open the app and the
  // dashboard data is null it will call the api to get data
  ...
  Widget build(BuildContext context) {
    //dashboardProvider is the instance of provider to get the data from api
    ...
    return Scaffold(
      //SideMenuBar is a class in which the side menu bar is present
      // in the body have container in which i design and appbar order bar and
      // today order listview separately
      // PortraitBottomNavigationBar is a class in which all the data of bottonm
                      ...
                      return Row(
                        children: [
                          Icon(Icons.person_outline_rounded,
                              color: Colors.white,
                              size: profileController
                                          .profileData['managerRole'] ==
                                      null
                                  ? 0
                                  : 45.w),
                          Text(
                              "${profileController.profileData['managerRole'] == null ? "" : profileController.profileData['managerRole']}",
                              style: TextStyle(
  ...
  Widget ordersBar(BuildContext context, double screenWidth) {
    return Container(
        ...
        child: Padding(
          ...
          child: Consumer<OrderProvider>(builder: (context, controller, child) {
            return Column(
              children: [
                Row(
                  children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              Consumer<DashboardProvider>(builder:
                                ...
                                return dashboardController.isLoading == 0
                                    ? Text(
                  ...
                  ? Consumer<DashboardProvider>(
                      ...
                      return controller.todayOrderList == null
                          ? Center(
                              child: Padding(
                                  padding:
                                      EdgeInsets.symmetric(vertical: 200.w),
                                  child: Text(
                                    "No Order Found! ",
                                    style: TextStyle(
                                        fontSize: 45.sp,
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                String orderId =
                                    controller.todayOrderList[index]['id'];
                                return Padding(
  ...
  //edgeInset20 is use for padding between the widgets
  //styleOrderBarNumber is the style of the buttons app order bar use for number/count
  //styleOrderBarName is the style of the text in order bar
